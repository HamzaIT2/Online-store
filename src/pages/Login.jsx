          ...
          >
            ...
            <Box sx={{ textAlign: 'center', mb: 4 }}>
              ...
              <Fade in timeout={1400}>
                <Typography variant="body2" sx={{ color: darkMode ? '#ffffff' : '#666', mb: 3 }}>
                  {t('login_subtitle')}
                </Typography>
              </Fade>
            </Box>
            ...
            <Box component="form" onSubmit={handleLogin}>
                    ...
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
                          <EmailOutlined sx={{ color: darkMode ? '#ffffff' : '#667eea' }} />
                        </InputAdornment>
                      ),
                    }}
                  />
                ...
                <Box sx={{ mb: 3 }}>
                  <TextField
                    ...
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
                          <LockOutlined sx={{ color: darkMode ? '#ffffff' : '#667eea' }} />
                        </InputAdornment>
                      ),
                      endAdornment: (
                        <InputAdornment position="end">
                          <IconButton
                            ...
                            sx={{ color: darkMode ? '#ffffff' : '#667eea' }}
                          >
              ...
              <Box sx={{ textAlign: 'center', mt: 4 }}>
                <Typography variant="body2" sx={{ color: darkMode ? '#f7f7f7' : '#666' }}>
                  {t('new_reg')}
                  <Link
                    component={RouterLink}
                    to="/register"
                  ...
                  <HowToReg sx={{ fontSize: 16, verticalAlign: 'middle', color: '#ffffff' }} />
                </Typography>
              </Box>
